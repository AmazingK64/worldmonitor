...
export const SOURCE_TYPES: Record<string, SourceType> = {
  ...
  'Digiday': 'tech', 'Adweek': 'market', 'Nieman Lab': 'tech',
  'Poynter': 'mainstream', 'Columbia Journalism Review': 'mainstream',
  'Broadcasting & Cable': 'mainstream', 'TV News Check': 'mainstream', 'Rapid TV News': 'mainstream',
  'Variety': 'mainstream', 'Hollywood Reporter': 'mainstream', 'Deadline': 'mainstream',
  'Billboard': 'mainstream', 'Screen Daily': 'mainstream', 'Axios Media': 'mainstream',
  'The Drum': 'market', 'MediaPost': 'market', 'Campaign': 'market', 'Marketing Week': 'market',
...
const MEDIA_FEEDS: Record<string, Feed[]> = {
  ...
  'media-business': [
    ...
    { name: 'Poynter', url: rss('https://www.poynter.org/feed/') },
    { name: 'Columbia Journalism Review', url: rss('https://www.cjr.org/feed/') },
  ...
  'media-policy': [
    ...
    { name: 'Press Freedom', url: rss('https://news.google.com/rss/search?q=(%22press+freedom%22+OR+%22journalism+law%22+OR+%22publisher+rights%22)+when:7d&hl=en-US&gl=US&ceid=US:en') },
  ],
  'media-platforms': [
    { name: 'Broadcasting & Cable', url: rss('https://www.nexttv.com/rss.xml') },
    { name: 'TV News Check', url: rss('https://tvnewscheck.com/rss/') },
    { name: 'Rapid TV News', url: rss('https://www.rapidtvnews.com/feed') },
  ...
  'media-culture': [
    ...
    { name: 'Billboard', url: rss('https://www.billboard.com/feed/') },
  ...
  'media-tech': [
    { name: 'TechCrunch', url: rss('https://techcrunch.com/feed/') },
    { name: 'The Verge', url: rss('https://www.theverge.com/rss/index.xml') },
    { name: 'Axios Media', url: rss('https://news.google.com/rss/search?q=site:axios.com+media+when:3d&hl=en-US&gl=US&ceid=US:en') },
  ...
  'media-audience': [
    { name: 'The Drum', url: rss('https://www.thedrum.com/rss') },
    { name: 'MediaPost', url: rss('https://www.mediapost.com/rss/') },
    { name: 'Campaign', url: rss('https://www.campaignlive.com/rss') },
    { name: 'Marketing Week', url: rss('https://www.marketingweek.com/feed/') },
