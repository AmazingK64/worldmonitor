...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  ...
  media: {
    title: 'Media Monitor - Real-Time Media Intelligence Dashboard',
    description: 'Real-time media industry dashboard for newsroom teams, editorial planning, topic discovery, audience signals, and cross-source story monitoring.',
    keywords: 'media dashboard, newsroom dashboard, editorial planning, topic discovery, media intelligence, audience signals, breaking news monitoring, publishing trends, content strategy, journalism workflow, communication dashboard, media industry monitor',
    url: 'https://media.worldmonitor.app/',
    siteName: 'Media Monitor',
    shortName: 'MediaMonitor',
    subject: 'Media Industry Monitoring, Editorial Planning, and Story Intelligence',
    classification: 'Media Dashboard, Newsroom Monitor, Editorial Intelligence Tool',
    categories: ['news', 'business'],
    features: [
      'Breaking news monitoring',
      'Topic discovery and story clustering',
      'Audience velocity signals',
      'Editorial planning feeds',
      'Platform and media tech tracking',
      'Regional story mapping',
