...
export class PanelLayoutManager implements AppModule {
  ...
  renderLayout(): void {
    ...
    const variantDocsBase = variantMeta.url.replace(/\/$/, '');
    ...
    this.ctx.container.innerHTML = `
      ...
      <nav class="mobile-menu" id="mobileMenu">
        ...
        <div class="mobile-menu-footer-links">
          ...
          <a href="${variantDocsBase}/blog/" target="_blank" rel="noopener">Blog</a>
          <a href="${variantDocsBase}/docs" target="_blank" rel="noopener">Docs</a>
